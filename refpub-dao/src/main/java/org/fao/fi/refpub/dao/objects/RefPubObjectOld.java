...
public class RefPubObjectOld {
	...
	private List<RefPubObjectOld> parents;
	private List<RefPubObjectOld> childrens;
	...
	public List<RefPubObjectOld> getParents() {
		return parents;
	}
	public void setParents(List<RefPubObjectOld> parents) {
		this.parents = parents;
	}
	public List<RefPubObjectOld> getChildrens() {
		return childrens;
	}
	public void setChildrens(List<RefPubObjectOld> childrens) {
