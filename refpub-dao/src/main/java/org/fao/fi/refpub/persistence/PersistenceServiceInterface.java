...
public abstract interface PersistenceServiceInterface {
	...
	MDConcept getConcept(
			@Param("db_schema") String db_schema, 
			@Param("concept") String concept);
	
	List<MDCodelist> getCodelistForConcept(
			@Param("db_schema") String db_schema, 
			@Param("concept") String concept);
	
	MDCodelist getDefaultCodelistFromConcept(
			@Param("db_schema") String db_schema, 
			@Param("concept") String concept);
	
	MDCodelist getCodeList(
			@Param("db_schema") String db_schema, 
			@Param("concept") String concept, 
	...
	ArrayList<HashMap<String, Object>> getObject(
			@Param("db_schema") String db_schema, 
			@Param("table") String table, 
	...
	ArrayList<HashMap<String, Object>> getObjectById(
			@Param("db_schema") String db_schema, 
			@Param("table") String table, 
			@Param("main_id") String pk_column, 
			@Param("id") String id);
	
	ArrayList<HashMap<String, Object>> getObjectByMeta(
			@Param("db_schema") String db_schema, 
			@Param("table") String table, 
			@Param("main_id") String pk_column,  
	...
	List<MDCodelist> getCodeList_listByConcept(
			@Param("db_schema") String db_schema, 
			@Param("concept") String concept);
	
	List<GenericType> getTableColumns(
			@Param("db_schema") String db_schema, 
			@Param("table") String table);
		
	ArrayList<HashMap<String, Object>> getParentHierarchy(
			@Param("db_schema") String db_schema, 
			@Param("table") String table,
	...
	ArrayList<HashMap<String, Object>> getRootParentHierarchy(
			@Param("db_schema") String db_schema, 
			@Param("table") String table,
			@Param("group_table") String group_table,
			@Param("group_column") String group_column,
	...
	List<MDGrouping> getGroups(
			@Param("db_schema") String db_schema,
			@Param("conceptId") int conceptId);
	
	ArrayList<HashMap<String, Object>> getGroupsValues(
			@Param("db_schema") String db_schema, 
	...
	ArrayList<HashMap<String, Object>> getHierarchy(
			@Param("db_schema") String db_schema, 
			@Param("filter") String filter);
	
	MDGrouping getGroupByFilter(
			@Param("db_schema") String db_schema,
			@Param("filter") String filter);
	
	MDGrouping getGroupByDescription(
			@Param("db_schema") String db_schema,
			@Param("short_description") String short_description);
	
	ArrayList<HashMap<String, Object>> getHierarchyForGroup(
			@Param("db_schema") String db_schema, 
			@Param("table") String table,  
			@Param("primary_key") String primary_key,
			@Param("meta_column") String meta_column,
			@Param("metacolumn_ret") String metacolumn_ret, 
			@Param("hid") String hierarchy_id);
	
	Integer isObjectBelongingToGroup(
			@Param("db_schema") String db_schema, 
			@Param("table") String table, 
			@Param("grp_column") String grp_column, 
			@Param("memb_column") String memb_column,
			@Param("group") String group, 
			@Param("item_id") String item_id);


	TableReference getTableReferenceByName(
			@Param("db_schema") String db_schema, 
			@Param("name") String name);
	
	TableReference getTableReferenceById(
			@Param("db_schema") String db_schema, 
			@Param("id") int id);
	...
	ArrayList<HashMap<String, Object>> getSubGroupHierarchy(
			@Param("db_schema") String db_schema,  
	...
	ArrayList<HashMap<String, Object>> getSubGroupHierarchyAlternative(
			@Param("db_schema") String db_schema,  
			@Param("itemTable") String itemTable,
	...
	ArrayList<HashMap<String, Object>> getFilteredObjectsHierarchy(
			...
			@Param("itemGroup_groupColumn") String itemGroup_groupColumn,
			@Param("itemGroup_memberColumn") String itemGroup_memberColumn,
			@Param("hierarchyGroup_metaColumn") String hierarchyGroup_metaColumn,
			@Param("filter") String filter,
			@Param("meta") List<String> meta);
	
	/*For commodities groups*/
	ArrayList<HashMap<String, Object>> getRootHierarchyCommodities(
			@Param("db_schema") String db_schema,
			@Param("hierarchyItemTable") String hierarchyItemTable,
			@Param("hierarchyItem_metaColumn") String hierarchyItem_metaColumn,
			@Param("groupTable") String groupTable,
	...
	ArrayList<HashMap<String, Object>> getSubGroupHierarchyCommodities(
			@Param("db_schema") String db_schema,  
			@Param("itemTable") String itemTable,
			@Param("groupTable") String groupTable,  
			@Param("hierarchyGroupTable") String hierarchyGroupTable,  
	...
	ArrayList<HashMap<String, Object>> getFilteredObjectsHierarchyCommodities(
			@Param("db_schema") String db_schema,  
			@Param("itemTable") String itemTable,
			@Param("groupTable") String groupTable,  
			@Param("item_primaryKey") String item_primaryKey,
	...
	ArrayList<HashMap<String, Object>> getChildsHierarchyAlternative(
			@Param("db_schema") String db_schema,  
			@Param("itemTable") String itemTable,
			@Param("groupTable") String groupTable,  
			@Param("item_primaryKey") String item_primaryKey,
	...
	ArrayList<HashMap<String, Object>> getFlatHierarchy(
			@Param("db_schema") String db_schema,  
			@Param("itemTable") String itemTable,
			@Param("groupTable") String groupTable,  
			@Param("item_primaryKey") String item_primaryKey,
