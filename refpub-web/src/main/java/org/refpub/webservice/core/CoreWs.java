...
public class CoreWs {
	...
	public Response concepts(
			@ApiParam(name = "type", value = "Output type {json/xml}", required = true) @PathParam("type") String type) {
	...
	public Response conceptList(
			@ApiParam(name = "concept", value = "Alphanumeric value of the concept", required = true) @PathParam("concept") String conceptCode,
			@ApiParam(name = "type", value = "Output type {json/xml}", required = true) @PathParam("type") String type) {
	...
	public Response codesystems(
			@ApiParam(name = "concept", value = "Alphanumeric value of the concept", required = true) @PathParam("concept") String concept,
			@ApiParam(name = "type", value = "Output type {json/xml}", required = true) @PathParam("type") String type) {
	...
	public Response codesystem(
			@ApiParam(name = "concept", value = "Alphanumeric value of the concept", required = true) @PathParam("concept") String concept,
			@ApiParam(name = "codesystem", value = "Alphanumeric value of the codesystem", required = true) @PathParam("codesystem") String codesystem,
			@ApiParam(name = "type", value = "Output type {json/xml}", required = true) @PathParam("type") String type) {
	...
	public Response code(
			@ApiParam(name = "concept", value = "Alphanumeric value of the concept", required = true) @PathParam("concept") String concept,
			@ApiParam(name = "codesystem", value = "Alphanumeric value of the codesystem", required = true) @PathParam("codesystem") String codesystem,
			@ApiParam(name = "code", value = "Alphanumeric value of the code", required = true) @PathParam("code") String code,
			@ApiParam(name = "type", value = "Output type {json/xml}", required = true) @PathParam("type") String type) {
	 ...
	 * public Response codeAttr(@ApiParam(name = "concept", value = "Alphanumeric value of the concept", required =
	 * true)
	 * 
	 ...
	 * 
	 * if ("json".equalsIgnoreCase(type)) { return this.codeAttrRun(concept, codesystem, this.getMediaType("json")); }
	 * else if ("xml".equalsIgnoreCase(type)) { return this.codeAttrRun(concept, codesystem, this.getMediaType("xml"));
	 * } else { return this.codeAttrRun(concept, codesystem, null); } }
	 */
	...
	public Response attrCodeXML(
			@ApiParam(name = "concept", value = "Alphanumeric value of the concept", required = true) @PathParam("concept") String concept,
			@ApiParam(name = "codesystem", value = "Alphanumeric value of the codesystem", required = true) @PathParam("codesystem") String codesystem,
			@ApiParam(name = "code", value = "Alphanumeric value of the code", required = true) @PathParam("code") String code,
			@ApiParam(name = "attribute", value = "Alphanumeric value of the attribute", required = true) @PathParam("attribute") String attribute,
			@ApiParam(name = "type", value = "Output type {json/xml}", required = true) @PathParam("type") String type) {
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Successful retrieval of the record for a concepts, codesystem and code", response = ConceptList.class) })
	public Response groupMain(
			@ApiParam(name = "concept", value = "Alphanumeric value of the concept", required = true) @PathParam("concept") String concept,
			@ApiParam(name = "group", value = "Alphanumeric value of the group", required = true) @PathParam("group") String group,
			@ApiParam(name = "type", value = "Output type {json/xml}", required = true) @PathParam("type") String type) {
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Successful retrieval of the record for a concepts, codesystem and code", response = ConceptList.class) })
	public Response getGroupXML(
			@ApiParam(name = "concept", value = "Alphanumeric value of the concept", required = true) @PathParam("concept") String concept,
			@ApiParam(name = "group", value = "Alphanumeric value of the group", required = true) @PathParam("group") String group,
			@ApiParam(name = "subgroup", value = "Alphanumeric value of the group", required = true) @PathParam("subgroup") String subgroup,
			@ApiParam(name = "type", value = "Output type {json/xml}", required = true) @PathParam("type") String type) {
	...
	private String getMediaType(HttpHeaders httpHeaders, String type) {
		...
		for (MediaType mt : httpHeaders.getAcceptableMediaTypes()) {
			...
			} else if (mt.equals(MediaType.APPLICATION_XML_TYPE)) { // note that this is application/xml and not
																	// text/xml
				return MediaType.APPLICATION_XML;
			}
		}
	...
	/*
	 * private Response codeAttrRun(String conceptCode, String codesystem, String mediatype) { setBean(); return new
	 * Execute(uriInfo, mediatype, context){ public Object run() { return
	 * bean.getAllAttributesForConceptAndCodesystem(conceptCode, codesystem); } public Object error(Exception err) {
	 * return bean.error(err); } }.execute(); }
	 */
	private Response attrCodeRun(String conceptCode, String codesystem, String code, String attribute,
			String mediatype) {
		setBean();
		return new Execute(uriInfo, mediatype, context) {
			public Object run() {
	...
	/*
	 * private Response subSubgroupRun(String conceptCode, String filter, String group, String subgroup, String
	 * mediatype) { setBean(); return new Execute(uriInfo, mediatype, context){ public Object run() { return
	 * bean.getSubGroups(conceptCode, filter, group, subgroup); } public Object error(Exception err) { return
	 * bean.error(err); } }.execute(); }
	 */
}
