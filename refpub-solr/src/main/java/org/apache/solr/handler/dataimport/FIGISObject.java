...
public class FIGISObject {
	...
	private String short_description_e;
	private String short_description_f;
	private String short_description_r;
	private String short_description_s;
	...
	public String getShort_description_e() {
		return short_description_e;
	}
	public void setShort_description_e(String short_description_e) {
		this.short_description_e = short_description_e;
	}
	public String getShort_description_f() {
		return short_description_f;
	}
	public void setShort_description_f(String short_description_f) {
		this.short_description_f = short_description_f;
	}
	public String getShort_description_r() {
		return short_description_r;
	}
	public void setShort_description_r(String short_description_r) {
		this.short_description_r = short_description_r;
	}
	public String getShort_description_s() {
		return short_description_s;
	}
	public void setShort_description_s(String short_description_s) {
		this.short_description_s = short_description_s;
	}
	public String getShort_description_a() {
		return short_description_a;
	}
	public void setShort_description_a(String short_description_a) {
		this.short_description_a = short_description_a;
	}
	public String getShort_description_c() {
		return short_description_c;
	}
	public void setShort_description_c(String short_description_c) {
		this.short_description_c = short_description_c;
	}
